...
export const ENEMY_META: Record<EnemyId, EnemyMeta> = {
  ...
  scarlet_captain: {
    ...
    role: "小型 Boss 级精英；山门战传授瞬步，试剑峰复测瞬步贴身与十字斩破枪势。",
  },
  faceless_sword: {
    id: "faceless_sword",
    label: "无面剑侍",
  ...
  formless_lord: {
    ...
    loreZones: ["无相殿最高层"],
    mapZones: ["peak"],
    moves: ["剑术阶段：瞬步追身、精准格挡、十字墨斩", "化境阶段：震地墨波与场地兵器镜像", "无相阶段：毒雾与水镜交替覆盖场地，要求闭息诀和水行符处理环境"],
    window: "瞬步残影消散、十字斩交叉点外侧、震地收势和水镜换层后均有明确输出窗；玩家需组合两项战斗招式与三项环境能力。",
    role: "篇章最终 Boss：完整复测瞬步、十字斩、震地击、闭息诀与水行符。",
    phases: ["瞬步 / 十字斩对剑", "震地镜像", "闭息毒雾 / 水行镜面"],
    reward: "归途传送权限",
  },
};
