...
export const ADDITIONAL_GATE_CONSTRUCTION: readonly GateConstructionSpec[] = [
  ...
  {
    id: "s07", screen: 6, name: "演武坪", role: "安全 / 叙事", entryY: 590, exitY: 260, entryCollider: "C50", exitCollider: "C54",
    mainPath: "M0 590H520L760 520L1030 440L1320 350L1672 260", upperPaths: ["M360 470H700", "M980 300H1300"],
    gameplayNote: "前半屏宽平降压并设置复活锚点；后半屏以四段折返山阶持续登高，明确把玩家送上S08高地。",
    colliders: [
      slab("C50", "演武坪西口", 0, 590, 520, "承接S06雨廊结构板；宽平安全地带与复活锚点"), floor("C51", "折返石阶一段", 520, 520, 240, "第一段抬升"),
      floor("C52", "折返石阶二段", 760, 440, 270, "第二段抬升"), floor("C53", "折返石阶三段", 1030, 350, 290, "第三段抬升"),
      floor("C54", "校场高地接驳", 1320, 260, 352, "贴齐S08高地西门，形成清晰天际线"),
      { id: "C55", name: "武器架观察台", kind: "oneway", x: 360, y: 470, w: 340, h: 18, note: "安全观察上方校场" },
      { id: "C56", name: "折返中段平台", kind: "oneway", x: 980, y: 300, w: 320, h: 18, note: "折返路径永久捷径落脚" },
      { id: "C57", name: "演武坪东侧暂封", kind: "boundary", x: 1260, y: 160, w: 22, h: 190, note: "引导玩家继续登高，不作为永久场景墙" },
    ],
    buildings: [
      { id: "A23", name: "演武坪武器架", x0: 180, y0: 430, x1: 520, y1: 590, material: "武器架 / 练功木人", shape: "shed" },
      { id: "A24", name: "高地折返石阶", x0: 520, y0: 120, x1: 1420, y1: 590, material: "青石阶 / 护栏 / 山壁", shape: "slope" },
      { id: "A25", name: "校场高地旗门", x0: 1320, y0: 70, x1: 1640, y1: 260, material: "战旗 / 高地门槛", shape: "gate" },
    ], encounters: [{ x: 420, y: 590, label: "复活锚点", tone: "safe" }, { x: 900, y: 440, label: "竹影刀客 ×1（巡逻）", tone: "basic" }],
  },
  {
    id: "s08", screen: 7, name: "守门校场", role: "精英 / 能力", entryY: 260, exitY: 260, entryCollider: "C58", exitCollider: "C63",
    mainPath: "M0 260H240L420 300H1220L1440 280L1672 260", upperPaths: ["M280 170H1390"],
    gameplayNote: "校场整体位于高地平台；全屏封锁只在战斗中启用，获瞬步后从东门保持高程进入S09下山箭廊。",
    colliders: [
      floor("C58", "校场高地西门", 0, 260, 240, "承接S07折返山阶顶端"), floor("C59", "校场西侧缓阶", 240, 300, 180, "进入高地主战平面"),
      ...
      { id: "C65", name: "西侧战斗封门", kind: "boundary", x: 250, y: 70, w: 24, h: 230, note: "仅战斗期间启用" },
      { id: "C66", name: "东侧战斗封门", kind: "boundary", x: 1410, y: 60, w: 24, h: 220, note: "击败赤枪校尉后永久关闭碰撞" },
    ],
    buildings: [
  ...
  },
  {
    ...
    gameplayNote: "盾卫战保留两侧绕背空间；绞盘交互区在弩线死角内，战后操作才解除东侧闸门。",
    colliders: [
      ...
      { id: "C93", name: "闸门战斗封锁", kind: "boundary", x: 1450, y: 280, w: 30, h: 340, note: "启动绞盘后永久移除" },
    ...
    ], encounters: [{ x: 720, y: 590, label: "铁甲盾卫", tone: "elite" }, { x: 1200, y: 370, label: "屋脊弩手", tone: "range" }, { x: 860, y: 500, label: "绞盘机关", tone: "system" }],
  },
  {
    ...
    colliders: [
      ...
      { id: "C101", name: "流送遮挡后沿", kind: "boundary", x: 1060, y: 390, w: 20, h: 245, note: "仅约束背景穿帮，不阻挡主路" },
    ],
    buildings: [
