...
const BLOCKS: SceneBlock[] = [
  ...
  { id: "s11", index: "11", name: GATE_SCREENS[10].name, x: SCREEN.w * 10, y: draftPx(450), kind: "combat", purpose: "区域压轴守门战，确认玩家掌握瞬步；绞盘负责战后开门演出。", landmark: "双层城楼、巨型绞盘、雨蚀铜门", entry: "山门前庭", exit: "击杀Boss解除封门后进入山门驿道", enemies: ["铁甲盾卫 Boss ×1", "屋脊弩手 ×1"], geometry: "城楼上下层 + 中央闸机 + 盾卫绕背空间", detailPriority: "Boss战动态封门、战后解除与绞盘开门演出" },
