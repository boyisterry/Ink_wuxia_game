...
const s06Dir = path.join(artRoot, "s06");
...
const files = {
  ...
  s05Background: path.join(artRoot, "s05/layers/00-background-mountains.png"),
  s05Foundation: path.join(artRoot, "s05/layers/50-foundation.png"),
